...
fn test_roberta_tokenization() -> anyhow::Result<()> {
    ...
    let expected_results = [
        ...
        TokenizedInput {
            token_ids: vec![
                0, 39980, 2961, 141, 42, 40, 120, 19233, 1538, 8103, 10470, 10674, 17487, 2,
            ],
            segment_ids: vec![],
            special_tokens_mask: vec![],
            overflowing_tokens: vec![],
        ...
        TokenizedInput {
            token_ids: vec![
                0, 4236, 7487, 29, 3553, 328, 29, 1437, 49585, 15375, 18537, 10809, 46927, 3070,
        ...
        TokenizedInput {
            token_ids: vec![
                0, 4236, 7487, 29, 3553, 328, 29, 1437, 1437, 1437, 49585, 15375, 18537, 10809, 2,
                46927, 3070, 2742, 21402, 1277, 9085, 1437, 121, 7210, 267, 2, 4654, 118, 4807,
                1437, 1437, 385, 1376, 3070, 8210, 257, 295, 1376, 3070, 18400, 2590, 2,
            ],
            segment_ids: vec![],
            special_tokens_mask: vec![],
            overflowing_tokens: vec![],
        ...
        TokenizedInput {
            token_ids: vec![
                0, 1437, 1437, 4236, 7487, 29, 3553, 328, 29, 1437, 1437, 1437, 1437, 49585, 15375,
                18537, 10809, 46927, 3070, 2742, 21402, 1277, 9085, 1437, 1437, 121, 7210, 267,
                4654, 118, 4807, 1437, 385, 1376, 3070, 8210, 257, 295, 1376, 3070, 18400, 2590,
        ...
        TokenizedInput {
            token_ids: vec![
                0, 1437, 1437, 47119, 4236, 7487, 29, 3553, 328, 29, 1437, 1437, 48693, 1437,
                49585, 15375, 18537, 10809, 46927, 3070, 2742, 21402, 1277, 9085, 1437, 1437, 121,
                7210, 267, 4654, 118, 4807, 1437, 385, 1376, 3070, 8210, 257, 295, 1376, 3070,
                18400, 2590, 1437, 1437, 1437, 1437, 1437, 2,
            ],
            segment_ids: vec![],
            special_tokens_mask: vec![],
            overflowing_tokens: vec![],
    ...
    let output =
        roberta_tokenizer.encode_list(&original_strings, 128, &TruncationStrategy::LongestFirst, 0);
